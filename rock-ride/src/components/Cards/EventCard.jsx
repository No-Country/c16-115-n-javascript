  ...
  return (
    <>
      <NavLink className={"flex lg:hidden"} to={`/event/${id}`}>
        <div className=" bg-cover text-[#ffffff]  bg-center   bg-[url('/will-truettner-wcT778-M1WE-unsplash.jpg')]  h-[13rem] sm:h-[16rem]  w-[100%] sm:w-[95%] ">
      ...
      <div className="hidden lg:flex bg-cover text-[#ffffff]  bg-center   bg-[url('/will-truettner-wcT778-M1WE-unsplash.jpg')]  h-[13rem] sm:h-[16rem] w-[100%] sm:w-[95%] ">
        <div className="backdrop-brightness-75 flex flex-col justify-between w-[100%] py-[2rem] px-[3rem] h-[100%] bg-black/40">
          <h3 className="text-[2.5rem] ">{Name}</h3>
          <div className="flex justify-between items-end">
            <NavLink to={`/event/${id}`}>
